...
print('--------------------------------------------------------------------')
a = 253.6*10+86.3*60+96.8*43+135.9*63+65.8*63+49.3*120+86.3*72+253.6*69+86.3*35+253.6*140
b = 86.3*90+135.9*24+65.8*45+96.8*25+86.3*60+65.8*129+253.6*10+96.8*43+65.8*63+86.3*60
c = 135.9*63+96.8*60+65.8*58+86.3*140+65.8*48+96.8*43+135.9*57+253.6*10+65.8*63+96.8*78
print('12月份销售总金额￥=',a+b+c)
d = 517/1844
print('牛仔裤的销售占量比：',d,"%")
print('羽绒服的销售占量比：',239/1844,"%")
print('风衣的销售占量比：',292/1844,"%")
print('皮草的销售占量比：',207/1844,"%")
print('t恤的销售占量比：',469/1844,"%")
print('衬衫的销售占量比：',120/1844,"%")
A = 1844
print('平均每日销售数量: ',A/30)
