...
time.sleep(2)
driver.find_element_by_id("loginname").send_keys("15233003864")
driver.find_element_by_id("nloginpwd").send_keys("LGQY1147")
...
# 获取图片信息，返回最佳匹配位置
def findPic(target="img1.jpg", template="img2.jpg"):
    # 读取图片
...
while True:
    try:
        ...
        request.urlretrieve(src2,"img2.jpg")
        x = findPic()
        print(x)


        # 按钮坐标
        offset_x,offset_y = 1220,600
        #pyautogui库操作鼠标指针
